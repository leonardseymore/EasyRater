...
{
    if (track) {
        NSString *alertMessage = [[NSString alloc] initWithFormat:NSLocalizedString(@"Track Delete Prompt", @"Prompt format for confirming if track should be deleted"), [track artist], [track album] , [track name]];
